...
const CATEGORY_FILE_TYPES = ["PDF", "XML", "ZIP", "DOCX", "PNG", "JPG"];
...
const DEFAULT_CATEGORIES = [
  defaultCategoryShape({ slug: "boleto", nome: "Boleto", icon: "card", padrao: true, cor: "gold", grupo: "Financeiro", ordem: 1, descricao: "Guias de pagamento mensais enviadas pela contabilidade.", config: { obrigatoria: true, exibirUpload: true, disponivelAdmin: true, disponivelColaborador: true, multiplosArquivos: true, permiteSubstituicao: false, exigirVersaoRecente: true } }),
  defaultCategoryShape({ slug: "cartao", nome: "Cartão CNPJ", icon: "card", padrao: true, cor: "navy", grupo: "Societário", ordem: 2, descricao: "Comprovante de inscrição e situação cadastral do CNPJ." }),
  defaultCategoryShape({ slug: "empresa", nome: "Documentos da Empresa", icon: "building", padrao: true, cor: "teal", grupo: "Societário", ordem: 3, descricao: "Contrato social, alvarás e demais documentos constitutivos." }),
  defaultCategoryShape({ slug: "contrato", nome: "Contrato", icon: "contract", padrao: true, cor: "purple", grupo: "Jurídico", ordem: 4, descricao: "Contratos de prestação de serviço firmados com o cliente." }),
  defaultCategoryShape({ slug: "declaracoes", nome: "Declarações", icon: "chart", padrao: true, cor: "green", grupo: "Fiscal", ordem: 5, descricao: "Declarações fiscais e demonstrativos entregues ao cliente." })
];
